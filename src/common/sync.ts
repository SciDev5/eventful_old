import { Simple, Ty, TyInner } from "./serialization"
import { Group, GroupId, int, ty_Group, ty_User, User } from "./ty_shared"
...
export const ty_SyncError = Simple.enum(SyncError)
...
const ty_SyncModeType = Simple.enum(SyncModeType)
export enum SyncStageType {
    Request,
    Resolve,
    Reject,
}
const ty_SyncStageType = Simple.enum(SyncStageType)

export enum SyncDataType {
    Session,
    Group
}
const ty_SyncDataType = Simple.enum(SyncDataType)
